...
<div style="display: flex; gap: 1rem; margin: 2rem 0; flex-wrap: wrap;">
  <div style="flex: 1; min-width: 200px; padding: 1.5rem; background: var(--ctp-surface0); border-radius: 8px; border-left: 4px solid var(--ctp-mauve);">
    <h3 style="margin: 0; color: var(--ctp-mauve);">40+</h3>
    <p style="margin: 0.5rem 0 0 0; color: var(--ctp-subtext0);">학습 문서</p>
  </div>
  <div style="flex: 1; min-width: 200px; padding: 1.5rem; background: var(--ctp-surface0); border-radius: 8px; border-left: 4px solid var(--ctp-blue);">
    <h3 style="margin: 0; color: var(--ctp-blue);">4</h3>
    <p style="margin: 0.5rem 0 0 0; color: var(--ctp-subtext0);">주요 모듈</p>
  </div>
  <div style="flex: 1; min-width: 200px; padding: 1.5rem; background: var(--ctp-surface0); border-radius: 8px; border-left: 4px solid var(--ctp-green);">
    <h3 style="margin: 0; color: var(--ctp-green);">10+</h3>
    <p style="margin: 0.5rem 0 0 0; color: var(--ctp-subtext0);">하위 카테고리</p>
  </div>
</div>
