--- 
title: "안전한 함수 설계: 클로저와 데코레이터 활용"
date: 2025-10-30
excerpt: "파이썬 함수의 4가지 유형과 가변 인자(*args, **kwargs) 활용법을 익히고, 변수의 유효 범위(LEGB 규칙)를 이해합니다. 클로저와 데코레이터를 이용해 코드의 재사용성을 높이고, 보안 관점에서 안전한 함수 구현 및 상태 관리 기법을 학습합니다."
categories:
  - Python
tags:
  - Python
