--- 
title: "보안 전문가를 위한 파이썬: 로그 분석과 실전 코딩 기초"
date: 2025-10-27
excerpt: "보안 관점에서 파이썬을 활용하는 방법을 배우고, 예약어 및 변수 명명 규칙 등 기초 문법을 익힙니다. 정형화된 로그 데이터의 중요성을 이해하고, 파이썬을 이용해 로그를 파싱하고 분석하는 실무적인 보안 코딩 역량을 키웁니다."
categories:
  - Python
tags:
  - Python
