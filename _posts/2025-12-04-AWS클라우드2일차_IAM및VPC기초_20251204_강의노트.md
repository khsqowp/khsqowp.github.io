--- 
title: "AWS 보안의 시작: IAM 권한 관리와 VPC 네트워크 구축"
date: 2025-12-04
excerpt: "AWS 계정 보안의 핵심인 IAM의 사용자, 그룹, 역할(Role), 정책(Policy) 구조를 완벽하게 이해합니다. 클라우드 네트워크의 기본인 VPC, 서브넷, 라우팅 테이블, 인터넷 게이트웨이를 직접 구축하며 안전한 네트워크 환경을 설계합니다."
categories:
  - AWS-Cloud
tags:
  - AWS-Cloud
