--- 
title: "IP 프로토콜의 핵심 기능: 패킷 분할부터 라우팅까지"
date: 2025-12-01
excerpt: "네트워크 계층의 핵심인 IP 프로토콜의 4대 기능(패킷 분할/조립, 주소 지정, 라우팅, 전송 제어)을 심층 분석합니다. MTU와 패킷 분할의 관계, 그리고 서로 다른 네트워크 간의 연결성을 확보하는 라우팅 메커니즘을 상세히 다룹니다."
categories:
  - Linux-Network
tags:
  - Linux-Network
