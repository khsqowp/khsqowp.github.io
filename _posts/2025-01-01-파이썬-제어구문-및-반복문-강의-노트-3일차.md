---
title: "📝 파이썬 제어구문 및 반복문 강의 노트 (3일차)"
date: 2025-01-01
excerpt: "오늘 강의에서는 파이썬의 핵심 문법인 제어구문(분기문)과 반복문에 대해 심도있게 배웠습니다. 지난 이틀 동안 변수의 타입(list, dict, tuple, set)을 다루면서 데이터를 다루는 기본기를 쌓았다면, 이제는 그 데이터를 가지고 의사결정을 내리고 반복 작..."
categories:
  - Python
tags:
  - Python
