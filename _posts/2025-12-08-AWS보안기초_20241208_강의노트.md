--- 
title: "AWS 네트워크 연결 전략: VPC Peering과 하이브리드 클라우드"
date: 2025-12-08
excerpt: "서로 다른 VPC를 연결하는 Peering과 Transit Gateway의 차이점을 이해하고, 온프레미스와 AWS를 연결하는 VPN 및 Direct Connect 구성 전략을 학습합니다. 전이적 피어링 불가 등 네트워크 연결 시 고려해야 할 보안 및 아키텍처 제약 사항을 분석합니다."
categories:
  - AWS-Cloud
tags:
  - AWS-Cloud
