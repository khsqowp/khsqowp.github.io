--- 
title: "파이썬 로직의 핵심: 제어문과 반복문의 활용"
date: 2025-10-29
excerpt: "조건부 실행을 위한 if-elif-else 분기문과 효율적인 작업을 위한 for, while 반복문의 실무 활용법을 익힙니다. input() 함수를 이용한 사용자 상호작용과 날짜/시간 데이터 처리, 그리고 3항 연산자를 활용한 간결한 코드 작성 기법을 학습합니다."
categories:
  - Python
tags:
  - Python
