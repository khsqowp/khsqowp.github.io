--- 
title: "웹 보안 실습의 기초: WebGoat 환경 구축과 인젝션 공격 심화"
date: 2025-12-19
excerpt: "오픈소스 보안 학습 플랫폼인 WebGoat을 리눅스 환경에 구축하고, 프록시 우회 및 로그 분석을 통한 기초 웹 해킹 환경을 이해합니다. SQL Injection의 UNION 공격 기법과 XML 기반의 XPath Injection 공격 원리를 실습하며 데이터 추출을 위한 다양한 공격 시나리오를 검증합니다."
categories:
  - App-Security
tags:
  - App-Security
