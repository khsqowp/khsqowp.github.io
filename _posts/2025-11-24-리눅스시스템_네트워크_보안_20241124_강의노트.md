--- 
title: "서버 인프라와 리눅스: 운영체제 구조 및 필수 명령어"
date: 2025-11-24
excerpt: "서버 인프라스트럭처의 진화 과정과 리눅스 운영체제의 커널 아키텍처를 학습합니다. 파일 시스템 구조, 프로세스 관리, 권한 설정 등 리눅스 시스템 관리자가 반드시 알아야 할 필수 명령어와 시스템 운영의 기본 원리를 익힙니다."
categories:
  - Linux-Network
tags:
  - Linux-Network
