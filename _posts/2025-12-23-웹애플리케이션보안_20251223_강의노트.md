--- 
title: "웹 보안 실전 기술: Burp Suite 활용과 세션 취약점 분석"
date: 2025-12-23
excerpt: "웹 해킹의 필수 도구인 Burp Suite의 Intruder 기능을 활용한 브루트 포스 공격과 자동화된 취약점 탐지 기법을 학습합니다. 세션 기반 로그인 시스템의 취약점을 이용한 세션 탈취 실습과 웹쉘 업로드 공격을 통해 웹 애플리케이션의 핵심 방어 기제와 대응 방안을 익힙니다."
categories:
  - App-Security
tags:
  - App-Security
