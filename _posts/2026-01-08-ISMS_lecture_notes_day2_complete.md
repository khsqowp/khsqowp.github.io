--- 
title: "보안 위험 관리의 정석: ISMS 인증 기준에 따른 자산 식별과 위험 평가"
date: 2026-01-08
excerpt: "조직의 정보 자산을 체계적으로 식별하고, 비즈니스 영향도를 고려한 위험 평가 방법론(Baseline, 상세 분석 등)을 상세히 다룹니다. 도출된 위험을 감소, 회피, 전가, 수용하는 전략적 의사결정 과정과 그에 따른 보호대책 수립 프로세스를 학습합니다."
categories:
